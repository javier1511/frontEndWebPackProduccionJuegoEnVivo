...
const getPlayersInSales = async () => {
    const getRequestInSales = new Get('https://juegoenvivodiamantetampico-5f11edf34527.herokuapp.com/players', token);
...
return salesErrors;
    ...
    salesMain.addEventListener('submit', async (event) => {
        ...
        try {
            ...
            const response = await fetch('https://juegoenvivodiamantetampico-5f11edf34527.herokuapp.com/sales', {
                method: 'POST',
                headers: {
